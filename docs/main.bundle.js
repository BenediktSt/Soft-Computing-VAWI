...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_6__angular_material__["h" /* MdMenuModule */],
    ...
    FuzzyComponent.prototype.calculate = function () {
        ...
        if (this.purchaseForm.status === 'VALID') {
            ...
            this.ruleResult.forEach(function (elem, index) {
                _this.result.push({
                    Produkt: _this.ruleResult[index].prod,
                    KaufenNiedrig: _this.ruleResult[index].buySet.low.reduce(add, 0) / _this.ruleResult[index].buySet.low.length,
                    KaufenMittel: _this.ruleResult[index].buySet.middle.reduce(add, 0) / _this.ruleResult[index].buySet.middle.length,
                    KaufenHoch: _this.ruleResult[index].buySet.high.reduce(add, 0) / _this.ruleResult[index].buySet.high.length
                });
            });
...
FuzzyComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["i" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["i" /* FormBuilder */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_material__["i" /* MdSnackBar */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_material__["i" /* MdSnackBar */]) === "function" && _b || Object])
], FuzzyComponent);
...
PredatorPreyComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["i" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["i" /* FormBuilder */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_material__["i" /* MdSnackBar */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_material__["i" /* MdSnackBar */]) === "function" && _c || Object])
